...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   linker_link_all_double_quotes.c                    :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
...
static void	linker_join_double_quotes(t_list_iter *it, t_token *curr,
...
void	linker_link_all_double_quotes(t_list *const token_pool,
		t_list *const token_pool_linked)
{
	t_list_iter	*it;
	t_token		*curr;
	...
	while (!it_end(it))
	{
		...
		{
			it_advance(it);
			linker_join_double_quotes(it, curr, token_pool_linked);
		}
		else if (curr != NULL)
		{
