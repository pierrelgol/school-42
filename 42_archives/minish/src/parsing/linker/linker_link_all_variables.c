...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   linker_link_all_variables.c                        :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: pollivie <pollivie.student.42.fr>          +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/07/06 14:07:22 by pollivie          #+#    #+#             */
/*   Updated: 2024/07/06 14:07:23 by pollivie         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "minishell.h"

void	linker_link_all_variables(t_list *const token_pool,
		t_list *const token_pool_linked)
{
	...
	while (!it_end(it))
	{
		...
		if (curr && next && curr->kind == KIND_VAR && next->kind == KIND_ID)
		{
